...
**Core concept count: 2** — the MinHeap data structure and the divide-sort-merge algorithm. Everything else (TopN, sorted runs, permutation indices) is scaffolding that supports these two.
